...
$(window).on('beforeunload', function(){
  ...
  function Upstatement() {
    ...
    document.getElementById('text-onclick1').innerHTML='Backend разработчик на Laravel';
    document.getElementById('text-onclick1-1').innerHTML=' @ 5G Store';
    document.getElementById('text-onclick2').innerHTML='Октябрь - Декабрь 2023';
    document.getElementById('text-onclick3-1').innerHTML='Создание и поддержка серверной инфраструктуры, обеспечие взаимодействие с базами данных, разработка бизнес-логики сайта';
    document.getElementById('text-onclick3-2').innerHTML='Интеграция с внешними сервисами, оптимизация производительности, разработка API ,а также безопасность приложения';
    document.getElementById('text-onclick3-3').innerHTML='Создал и настроил административную панель для интернет-магазина, обеспечивая удобное управление содержимым и данными магазина.';
  ...
  function scout() {
    ...
    document.getElementById('text-onclick1-1').innerHTML=' @ ID Electronics';
    document.getElementById('text-onclick2').innerHTML='Июль - Сентябрь 2023';
    document.getElementById('text-onclick3-1').innerHTML='Разработка программного обеспечения как на стороне клиента (фронтенд), так и на стороне сервера (бэкенд)';
    document.getElementById('text-onclick3-2').innerHTML='Создание пользовательского интерфейса (UI) с использованием языков разметки (HTML), стилей (CSS) и скриптов (JavaScript)';
    document.getElementById('text-onclick3-3').innerHTML='Использование бэкенд-фреймворка Laravel для взаимодействия серверной и клиентской части.';
  ...
  function apple() {
    ...
    document.getElementById('text-onclick2').innerHTML='Февраль - Июнь 2023';
    document.getElementById('text-onclick3-1').innerHTML='Верстка по макетам с использованием HTML и CSS, разработка интерактивных элементов с применением JavaScript';
    document.getElementById('text-onclick3-2').innerHTML='Интеграция дизайна в функциональные пользовательские интерфейсы, обеспечие кроссбраузерности и адаптивности';
    document.getElementById('text-onclick3-3').innerHTML='Отладка кода для обеспечения высокого уровня функциональности и качественного пользовательского опыта.';
  ...
  function showLess() {  //добавить элементы 
  ...
  function showMore() {  //убрать элементы 
